# -*- encoding: utf-8 -*-
# stub: slack-ruby-client 0.14.6 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<rubocop-performance>.freeze, ["~> 1.4.1"])
      s.add_development_dependency(%q<rubocop-rspec>.freeze, ["~> 1.34.0"])
      ...
      s.add_dependency(%q<rubocop-performance>.freeze, ["~> 1.4.1"])
